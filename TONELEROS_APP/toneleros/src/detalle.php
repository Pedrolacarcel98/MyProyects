...
<head>
    ...
    <style>
        ...
        .card-body ul li {
            border-left: 4px solid rgba(1,1,1,1);
            padding-left: 10px;
        }
        .card-body ul strong {
            color: #343a40;
            ...
            <div class="col-lg-8">
                <div class="card">
                    <div class="card-header bg-black text-white">
                        <h5 class="mb-0">Detalles de la Actuación</h5>
                    </div>
                    <div class="card-body">
                        <ul class="list-unstyled">
                            ...
                            if ($fila = mysqli_fetch_assoc($datos)) { 
                                ...
                                $equipo = ($fila["equipo"] == 0) ? "Cliente" : "Nuestro";
                            ?>
                            <li class="mb-3">
                            ...
                            <?php } else { ?>
                                <div class="alert alert-warning">No se encontró la actuación.</div>
                            <?php } ?>
                        </ul>
